...
-- HƯỚNG DẪN HIỂN THỊ
-- =====================================================
local info = Instance.new("124370362383827")
info.Size = UDim2.new(1, 0, 0, 25)
info.Position = UDim2.new(0, 0, 1, -25)
info.BackgroundColor3 = Color3.fromRGB(20, 20, 30)
info.Text = "Nhấn 'X' để ẩn/hiện menu | YungK để đóng"
info.TextColor3 = Color3.fromRGB(200, 200, 200)
info.TextScaled = true
info.Font = Enum.Font.SourceSans
info.Parent = mainFrame

-- PHÍM TẮT TOGGLE MENU (YungK)
...
print("[Blox Menu] Đã tải menu thành công. Nhấn YungK để ẩn/hiện.")